 ...
 * draft or refine plan turns. When present, Dagong exposes the
...
export type ToolHostContext = {
  ...
  workspace: string
  /**
   * Thread mode advertised by the GUI. Dagong restricts plan tools
  ...
  /** Dagong runtime data root; used to allow sandbox-safe reads of background shell output files. */
