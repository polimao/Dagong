/**
 * Dagong-side mirror of the shared GUI plan contract from
 * Dagong's `src/shared/gui-plan.ts`.
 *
 * The renderer and the Dagong package live in the same repo but
 * TypeScript's `rootDir` constraint prevents Dagong from
