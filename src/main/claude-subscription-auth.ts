 ...
 * existing candidate under the given dagong roots, or undefined to fall back to a
 * `claude` on PATH.
 */
export function resolveBundledClaudeBinary(dagongRoots: readonly string[]): string | undefined {
  const arch =
