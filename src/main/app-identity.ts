 ...
 *
 * 2026-06 起品牌从 “DeepSeek GUI” 升级为 “MagicPocket”。这个名字同时决定
 * userData 默认目录(appData/MagicPocket),老目录由 legacy-data-migration.ts
 ...
 */
export const APP_PRODUCT_NAME = 'MagicPocket'
