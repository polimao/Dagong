 ...
 * the native Dagong `create_plan` tool; the renderer still emits a
 * brief tag-based fallback section for legacy providers.
 */
export const GUI_PLAN_CREATE_TOOL_NAME = 'create_plan'
const DRAFT_PLAN_INTRO = 'Dagong is asking you to draft a GUI-owned implementation plan.'
const REFINE_PLAN_INTRO = 'Dagong is asking you to revise an existing GUI-owned implementation plan.'
