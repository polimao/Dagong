...
import dagongBirdFigure from '../../../asset/img/dagong_bird.png'
...
function ModeCardButton({
  ...
  onActivate: () => void
  onRemove?: () => void
  /** 切换 Retroma 羊皮纸配色(仅默认 Dagong 卡片提供) */
          ...
          <div className="flex w-full flex-col gap-3">
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {[...builtinCards, ...pluginCards].map((card) => {
                ...
                // 默认 Dagong 卡承载 Retroma 配色:default 或 retroma 均视为该卡激活
                const cardActive =
