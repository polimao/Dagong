...
describe('PluginMarketplaceView MCP config helpers', () => {
  it('does not recommend the filesystem MCP server because Dagong has built-in file tools', () => {
  ...
  it('builds remote OAuth MCP server config using Dagong-supported transport fields', () => {
  ...
  it('accepts custom JSON as either a single server or a Dagong config fragment', () => {
  ...
  it('detects MCP servers from full Dagong capability config', () => {
  ...
  it('toggles nested Dagong capability MCP servers', () => {
