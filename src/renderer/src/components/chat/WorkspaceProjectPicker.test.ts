...
describe('buildWorkspaceProjectPickerOptions', () => {
  it('groups remembered worktree roots under their source project', () => {
    ...
    const worktree38e2 = '/Users/zxy/.dagong/worktrees/38e2/Kook-VoiceShop-Bot'
    const worktreePython = '/Users/zxy/.dagong/worktrees/python/Kook-VoiceShop-Bot'
  ...
  it('excludes conversation workspaces from project picker options', () => {
    ...
    const result = buildWorkspaceProjectPickerOptions({
      ...
      workspaceRoots: [
        '/Users/zxy/project-a',
        '/Users/zxy/Documents/Dagong/20260626-153012', // conversation workspace
        '/Users/zxy/project-b'
      ],
      conversationWorkspaceRoot: '/Users/zxy/Documents/Dagong'
    })
  ...
  it('includes regular project folders but excludes conversation workspaces', () => {
    const result = buildWorkspaceProjectPickerOptions({
      currentWorkspaceRoot: '/Users/zxy/Documents/Dagong/20260627-091234', // conversation workspace as current
      workspaceRoots: [
        '/Users/zxy/project-x',
        '/Users/zxy/project-y',
        '/Users/zxy/Documents/Dagong/20260626-153012' // another conversation workspace
      ],
      conversationWorkspaceRoot: '/Users/zxy/Documents/Dagong'
    })
    ...
    expect(optionRoots).not.toContain('/Users/zxy/Documents/Dagong/20260626-153012')

    // Current root should still be returned even if it's a conversation workspace
    expect(result.currentRoot).toBe('/Users/zxy/Documents/Dagong/20260627-091234')
  })
