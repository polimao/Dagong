...
export const WRITE_PREVIEW_MODE_KEY = 'dagong.write.preview-mode'
export const WRITE_ASSISTANT_OPEN_KEY = 'dagong.write.assistant-open'
export const WRITE_ASSISTANT_MODEL_KEY = 'dagong.write.assistant-model'
export const WRITE_ASSISTANT_PROVIDER_KEY = 'dagong.write.assistant-provider'
...
export function activeFileStorageKey(workspaceRoot: string): string {
  return `dagong.write.active-file:${normalizePath(workspaceRoot)}`
}
