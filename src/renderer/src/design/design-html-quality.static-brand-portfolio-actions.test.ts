    ...
    it('flags landing pages whose navigation lacks a visible brand identity', () => {
      const findings = auditDesignHtmlQuality({
        html: [
          ...
          '<figure class="product-preview"><img src=".dagong-design/assets/dispatch-preview.png" alt="Dispatch board preview">',
    ...
    it('flags portfolio and case-study pages without concrete project entries', () => {
      const findings = auditDesignHtmlQuality({
        html: [
          ...
          '<figure class="product-preview"><img src=".dagong-design/assets/studio-preview.png" alt="Aria Studio selected work preview">',
    ...
    it('accepts portfolio and case-study pages with project cards and outcome CTAs', () => {
      const findings = auditDesignHtmlQuality({
        html: [
          ...
          '<article class="project-card"><img src=".dagong-design/assets/northstar.png" alt="Northstar Labs project preview"><h3>Northstar Labs launch</h3>',
          ...
          '<article class="project-card"><img src=".dagong-design/assets/juniper.png" alt="Juniper Studio project preview"><h3>Juniper Studio refresh</h3>',
    ...
    it('flags portfolio and case-study cards with placeholder project labels', () => {
      const findings = auditDesignHtmlQuality({
        html: [
          ...
          '<span>Northstar Labs</span><span>Acme Finance</span><span>Juniper Studio</span></section>',
          '<section id="work"><h2>Selected work</h2><div class="work-grid">',
          '<article class="project-card"><img src=".dagong-design/assets/project-one.png" alt="Project One preview"><h3>Project One</h3>',
          ...
          '<article class="project-card"><img src=".dagong-design/assets/case-study-two.png" alt="Case Study 2 preview"><h3>Case Study 2</h3>',
