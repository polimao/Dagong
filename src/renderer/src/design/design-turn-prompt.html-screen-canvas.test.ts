...
describe("design turn prompt HTML, screen, and canvas guidance", () => {
    it('builds a parallel page fanout prompt with one delegate_task per artifact', () => {
        ...
        jobs: [
          {
            artifactId: 'landing',
            title: 'Landing',
            relativePath: '.dagong-design/doc/landing/v1.html',
            designMdPath: '.dagong-design/doc/landing/DESIGN.md',
          ...
          },
          {
            ...
            title: 'Community',
            relativePath: '.dagong-design/doc/community/v1.html',
            designMdPath: '.dagong-design/doc/community/DESIGN.md',
            brief: 'Community feed and member stories',
            screenManifest: [{ name: 'Design system', htmlPath: '.dagong-design/doc/system/v1.html', role: 'design-system' }]
          }
        ]
      })
      ...
      expect(prompt).toContain('Modify ONLY `.dagong-design/doc/landing/v1.html` and `.dagong-design/doc/landing/DESIGN.md`')
      expect(prompt).toContain('Modify ONLY `.dagong-design/doc/community/v1.html` and `.dagong-design/doc/community/DESIGN.md`')
        ...
        jobs: [
          {
            artifactId: 'home',
            title: 'Today',
            relativePath: '.dagong-design/doc/today/v1.html',
            designMdPath: '.dagong-design/doc/today/DESIGN.md',
    ...
    it('allows only the reserved HTML and companion design notes files for HTML turns', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        designNotesPath: '.dagong-design/screen/DESIGN.md',
        workspaceRoot: '/workspace'
      })
  
      expect(prompt).toContain('Design notes file: .dagong-design/screen/DESIGN.md')
      expect(prompt).toContain('Design target: Web')
      expect(prompt).toContain('1280x800 desktop web')
      expect(prompt).toContain(
        'Modify ONLY `.dagong-design/screen/v1.html` and `.dagong-design/screen/DESIGN.md`'
      )
    ...
    it('biases screen prompts toward mobile app frames when the design target is app', () => {
      const options: ScreenTurnOptions = {
        ...
        artifactRelativePath: '.dagong-design/habit/v1.html',
        workspaceRoot: '/workspace',
    ...
    it('passes selected screen frame details and notes file for screen turns', () => {
      const options: ScreenTurnOptions = {
        ...
        artifactRelativePath: '.dagong-design/screen/v2.html',
        designNotesPath: '.dagong-design/screen/DESIGN.md',
        basePath: '.dagong-design/screen/v1.html',
        workspaceRoot: '/workspace',
        screenName: 'Login',
        screenWidth: 420,
        screenHeight: 340,
        ...
        screenManifest: [
          {
            ...
            width: 1280,
            height: 720,
            htmlPath: '.dagong-design/home/v1.html'
          }
        ]
      }
      const prompt = buildDesignTurnPrompt(options)
      ...
      expect(prompt).toContain('Design notes file: .dagong-design/screen/DESIGN.md')
      expect(prompt).toContain('Modify ONLY `.dagong-design/screen/v2.html` and `.dagong-design/screen/DESIGN.md`')
      ...
      expect(prompt).toContain('.dagong-design/home/v1.html')
    })
    it('injects real frame dimensions into HTML iteration prompts', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.dagong-design/system/v2.html',
        designNotesPath: '.dagong-design/system/DESIGN.md',
        basePath: '.dagong-design/system/v1.html',
        workspaceRoot: '/workspace',
        frameContext: {
          name: 'Design system',
          width: 1330,
    ...
    it('includes sibling pages so HTML turns stay cohesive across the canvas', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.dagong-design/settings/v1.html',
        workspaceRoot: '/workspace',
        screenManifest: [
          { name: 'Home', htmlPath: '.dagong-design/home/v1.html', summary: 'Landing page' },
          { name: 'Chat', width: 420, height: 720, htmlPath: '.dagong-design/chat/v1.html' }
        ]
      })
  
      expect(prompt).toContain('Other pages already in this project')
      expect(prompt).toContain('"Home" → .dagong-design/home/v1.html (prototype href: ../home/v1.html) — Landing page')
      expect(prompt).toContain('"Chat" (420x720) → .dagong-design/chat/v1.html (prototype href: ../chat/v1.html)')
    ...
    it('computes local prototype hrefs between generated HTML artifacts', () => {
      expect(buildPrototypeHref('.dagong-design/doc/settings/v1.html', '.dagong-design/doc/home/v1.html')).toBe('../home/v1.html')
      expect(buildPrototypeHref('.dagong-design/doc/a/b/v1.html', '.dagong-design/doc/c/v1.html')).toBe('../../c/v1.html')
      expect(buildPrototypeHref(undefined, '.dagong-design/doc/home/v1.html')).toBe('.dagong-design/doc/home/v1.html')
    })
    ...
    it('adds iteration edit discipline for existing screen edits without requiring an element selection', () => {
      const options: ScreenTurnOptions = {
        ...
        artifactRelativePath: '.dagong-design/pricing/v2.html',
        basePath: '.dagong-design/pricing/v1.html',
        workspaceRoot: '/workspace',
        screenName: 'Pricing',
        screenManifest: []
      }
    ...
    it('tells the agent the path + directory of selected design artifacts (no inlined content)', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.dagong-design/board/settings/v1.html',
        workspaceRoot: '/workspace',
        contextLocations: [
          {
            title: 'Settings',
            kind: 'html',
            path: '.dagong-design/board/settings/v1.html',
            directory: '.dagong-design/board/settings'
          },
          {
            title: 'Hero',
            kind: 'image',
      ...
      expect(prompt).toContain('Settings [html] → `.dagong-design/board/settings/v1.html` (directory: `.dagong-design/board/settings`)')
    ...
    it('renders per-sibling accent + font + summary in the screen manifest', () => {
      const prompt = buildDesignTurnPrompt({
        ...
        artifactRelativePath: '.dagong-design/doc/p/v1.html',
        workspaceRoot: '/ws',
        screenManifest: [
          {
            name: 'Home',
