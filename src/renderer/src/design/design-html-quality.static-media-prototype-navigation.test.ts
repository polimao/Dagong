...
describe("auditDesignHtmlQuality document readiness and states0", () => {
    it('accepts named and decorative images', () => {
      const findings = auditDesignHtmlQuality({
        html: [
          ...
          '<img src=".dagong-design/assets/customer.png" alt="Portrait of Mina Chen">',
          '<img src=".dagong-design/assets/ring.png" alt="">',
          '<img src=".dagong-design/assets/grid.png" role="presentation">',
    ...
    it('flags multi-screen pages that do not link to sibling screens', () => {
      const findings = auditDesignHtmlQuality({
        ...
        siblingScreens: [
          { name: 'Home', htmlPath: '.dagong-design/doc/home/v1.html', prototypeHref: '../home/v1.html' }
        ]
      })
    ...
    it('accepts prototype navigation attributes intercepted by the player', () => {
      const findings = auditDesignHtmlQuality({
        ...
        siblingScreens: [
          { name: 'Home', htmlPath: '.dagong-design/doc/home/v1.html', prototypeHref: '../home/v1.html' },
          { name: 'Settings', htmlPath: '.dagong-design/doc/settings/v1.html', prototypeHref: '../settings/v1.html' }
        ]
      })
      const codes = findings.map((finding) => finding.code)
    ...
    it('counts inline location.hash prototype handlers as sibling navigation', () => {
      const findings = auditDesignHtmlQuality({
        ...
        siblingScreens: [
          { name: 'Home', htmlPath: '.dagong-design/doc/home/v1.html', prototypeHref: '../home/v1.html' },
          { name: 'Settings', htmlPath: '.dagong-design/doc/settings/v1.html', prototypeHref: '../settings/v1.html' },
          { name: 'Weekly Stats', htmlPath: '.dagong-design/doc/weekly-stats/v1.html', prototypeHref: '../weekly-stats/v1.html' }
        ]
      })
      const codes = findings.map((finding) => finding.code)
    ...
    it('does not accept duplicate page-title prototype targets as resolved navigation', () => {
      const findings = auditDesignHtmlQuality({
        ...
        siblingScreens: [
          { name: 'Settings', htmlPath: '.dagong-design/doc/account-settings/v1.html', prototypeHref: '../account-settings/v1.html' },
          { name: 'Settings', htmlPath: '.dagong-design/doc/project-settings/v1.html', prototypeHref: '../project-settings/v1.html' }
        ]
      })
    ...
    it('accepts unique route-style prototype href slugs that the player can resolve', () => {
      const findings = auditDesignHtmlQuality({
        ...
        siblingScreens: [
          { name: 'Account Settings', htmlPath: '.dagong-design/doc/account-settings/v1.html', prototypeHref: '../account-settings/v1.html' },
          { name: 'Weekly Stats', htmlPath: '.dagong-design/doc/weekly-stats/v1.html', prototypeHref: '../weekly-stats/v1.html' }
        ]
      })
      const codes = findings.map((finding) => finding.code)
    ...
    it('does not accept ambiguous route-style prototype href slugs as resolved navigation', () => {
      const findings = auditDesignHtmlQuality({
        ...
        siblingScreens: [
          { name: 'Account Settings', htmlPath: '.dagong-design/doc/account-settings/v1.html', prototypeHref: '../account-settings/v1.html' },
          { name: 'Project Settings', htmlPath: '.dagong-design/doc/project-settings/v1.html', prototypeHref: '../project-settings/v1.html' }
        ]
      })
    ...
    it('flags multi-screen projects that link to only one sibling screen', () => {
      const findings = auditDesignHtmlQuality({
        ...
        siblingScreens: [
          { name: 'Home', htmlPath: '.dagong-design/doc/home/v1.html', prototypeHref: '../home/v1.html' },
          { name: 'Settings', htmlPath: '.dagong-design/doc/settings/v1.html', prototypeHref: '../settings/v1.html' },
          { name: 'Reports', htmlPath: '.dagong-design/doc/reports/v1.html', prototypeHref: '../reports/v1.html' }
        ]
      })
      const codes = findings.map((finding) => finding.code)
