...
const SKELETON_MARKER = 'Dagong is preparing a live preview'
...
<body>
  <main aria-live="polite">
    ...
    <p>Dagong is preparing a live preview for <code>${safePath}</code>. The canvas will refresh as the HTML file changes.</p>
  </main>
</body>
</html>
`
