...
import { expandHomePath, RuntimeTuningConfigSchema } from './magicpocket-config.js'
...
describe('expandHomePath', () => {
  it('expands Windows-style home-relative paths', () => {
    expect(expandHomePath('~\\magicpocket\\config.json')).toBe(join(homedir(), 'magicpocket', 'config.json'))
  })
