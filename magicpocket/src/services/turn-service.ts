...
export class TurnService {
   ...
   * caller can resume goals that were interrupted mid-run (MagicPocketAgent/MagicPocket#370).
   */
  async reconcileOrphanedTurns(): Promise<string[]> {
    ...
    // tool item) stay pending forever, wedging the thread (MagicPocketAgent/MagicPocket#621).
