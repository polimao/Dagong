 ...
 * draft or refine plan turns. When present, MagicPocket exposes the
...
export type ToolHostContext = {
  ...
  workspace: string
  /**
   * Thread mode advertised by the GUI. MagicPocket restricts plan tools
  ...
  /** MagicPocket runtime data root; used to allow sandbox-safe reads of background shell output files. */
