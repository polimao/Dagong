/**
 * MagicPocket-side mirror of the shared GUI plan contract from
 * MagicPocket's `src/shared/gui-plan.ts`.
 *
 * The renderer and the MagicPocket package live in the same repo but
 * TypeScript's `rootDir` constraint prevents MagicPocket from
