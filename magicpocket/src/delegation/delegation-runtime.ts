...
export class DelegationRuntime {
  ...
  async runChild(input: {
    ...
    // Workspace overlay: `.magicpocket/agents/*.md` in the call's workspace wins
   ...
   * in-flight indefinitely, and the parent thread stays wedged (MagicPocketAgent/MagicPocket#621).
