...
function printUsage(): void {
  console.log('Usage:')
  console.log('  npm --prefix magicpocket run benchmark:replay -- --suite <file> [options]')
  console.log('')
  console.log('Options:')
  console.log(`  --base-url <url>          MagicPocket runtime URL (or KUN_RUNTIME_URL, default ${DEFAULT_RUNTIME_URL})`)
